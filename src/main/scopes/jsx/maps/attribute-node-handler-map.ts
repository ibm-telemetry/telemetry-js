...
import { IdentifierHandler } from '../node-handlers/attributes/identifier-handler.js'
 ...
 */
export const attributeNodeHandlersMap: AttributeNodeHandlerMap = {
...
export const getAttributeNodeHandler = (
  ...
  const Handler = attributeNodeHandlersMap[nodeKind] ?? DefaultHandler
